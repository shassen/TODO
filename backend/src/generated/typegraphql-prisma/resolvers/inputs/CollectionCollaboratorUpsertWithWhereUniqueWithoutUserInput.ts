...
@TypeGraphQL.InputType("CollectionCollaboratorUpsertWithWhereUniqueWithoutUserInput", {})
export class CollectionCollaboratorUpsertWithWhereUniqueWithoutUserInput {
  ...
  update!: CollectionCollaboratorUpdateWithoutUserInput;
