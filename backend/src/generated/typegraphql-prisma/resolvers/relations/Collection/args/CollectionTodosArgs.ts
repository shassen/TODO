...
export class CollectionTodosArgs {
  ...
  distinct?: Array<"id" | "title" | "content" | "completed" | "isDeleted" | "isArchived" | "dueDate" | "createdAt" | "updatedAt" | "deletedAt" | "archivedAt" | "collectionId" | "creatorId"> | undefined;
}
