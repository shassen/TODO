...
export class UserCollectionsArgs {
  ...
  distinct?: Array<"id" | "name" | "description" | "isDeleted" | "isActive" | "isArchived" | "createdAt" | "updatedAt" | "deletedAt" | "archivedAt" | "ownerId"> | undefined;
}
